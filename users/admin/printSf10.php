    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <a href="print_sf10?grade=<?= $filter_grade ?>&section=<?= $filter_section ?>&studId=<?= $student_id; ?>" class="btn btn-danger btn-sm mb-3" target="_blank"><i class="fas fa-print"></i> Print</a>
