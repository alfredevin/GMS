    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid  "> <a href="student_clearance" class="btn btn-primary btn-sm mb-3"> Back to Page</a>
                    ...
                    <div class="card shadow mb-4  ">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                $student_id = $_GET['student_id']; // or however you get the student
                                $student_grade = $section_grade; // example, or from DB
